					...
					<div class="panel-group" id="accordion">
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-four" class="panel-collapse collapse">
								<div class="panel-body">
									<p>容器に関しましては運営がすべてご用意致します。<br/>
										ご登録頂いた際にご住所に送付させていただきます。また容器がなくなりましたら、<a href="contact-us">お問い合わせフォーム</a>から容器をご依頼ください。。</p>
									<p>
										なお容器が到着する前でも、ご自身で使い捨て容器等をご用意いただき、おすそ分けを開始していただくことも可能です。<br/>
										ご自身で容器をご用意頂く場合、オーダー1個につき、おおよそ1人前の分量になるようにご準備下さい。
									</p>
								</div>
							</div>
						</div><!-- panel -->
