					...
					<div class="panel-group" id="accordion">
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-one" class="panel-collapse collapse collapse in">
								<div class="panel-body">
									...
									<p>おすそ分けしたいお料理をシェアメシサイト上にアップし、メシイーターさんへおすそ分け頂きます。地域貢献/見守り、配送、お料理の３点について値付けを頂きます。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-two" class="panel-collapse collapse">
								<div class="panel-body">
									<p>お料理はメシクリエーターさんご本人、あるいはそのご家族にお届けしてもらうことを推奨しております。これはお料理のお届けまでをメシクリエーターさんご本人またはご家族に行っていただくことで、その思いも地域のメシイーターさんにお届けいただいたり、見守り役としての役目も果たして頂くなど、シェアメシを通してメシイーターさんとのコミュニケーションや繋がりを楽しんで頂きたいと願っておりますためです。お渡し頂き、メシクリエーターさんがお食事を済まされ、メシクリエーターさんへ評価をされた後、メシイーターさんへの評価をお願いしております。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-four" class="panel-collapse collapse">
								<div class="panel-body">
									<p>お問い合わせから、容器をご依頼ください。<br/>
										無料で運営が容器をご用意し、ご登録頂いたご住所に送付させていただきます(送料も運営負担で無料)。なお容器がなくなるタイミングになりましたら、お手数ですが、<a href="contact-us">お問い合わせフォーム</a>から再度ご依頼ください。</p>
									<p>
										また容器が到着する前でも、ご自身で使い捨て容器等をご用意くだされば、おすそ分けを開始していただくことが可能です。<br/>
										ご自身で容器をご用意頂く場合、オーダー1個が大体1人前になるようにご準備下さい。
									</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-five" class="panel-collapse collapse">
								<div class="panel-body">
									<p>シェアメシのサービスは、その地域に住む方々で、お料理を提供したい方、お料理を食べたい方をシェアメシサイト上でマッチング、個人個人の繋がりを感じてもらった上で、お料理のおすそわけを行うサービスとなります、従い不特定多数へのサービスではなく、地域に密着した助け合いのサービスであると解釈しており、保健所の許可や飲食店営業許可などに抵触するものではありません。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#accordion" href="#faq-seven">
									<h4 class="panel-title">
										食あたり等、自分の料理を食べたメシイーターさんに問題が発生した場合はどうなるの？
										<span class="pull-right"><i class="fa fa-minus"></i></span>
									</h4>
								</a>
							</div><!-- panel-heading -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-eight" class="panel-collapse collapse">
								<div class="panel-body">
									<p>お料理をお届けいただいた後、申請ページより申請していただきます。申請に問題が無いことが確認できましたら6営業日以内に振込が行われます。</p>
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-nine" class="panel-collapse collapse">
								<div class="panel-body">
									...
									<p>2.予約が入ればメシイーターさんが指定した時間にお届け頂き完了です。</p>
									<p></p>
									<p>※なおご登録後、運営から順次、写真撮影、動画撮影などの手配をひとりひとりに丁寧に行わせて頂きますので、ご連絡をお待ち下さい。</p>
									<p>（写真撮影や、動画撮影を行わせて頂くことで、メシイーターの方々がメシクリエーターの方々をより身近に感じることができ、より選ばれやすくなります！なお運営からのご連絡前にも、上記ステップでお料理のご提供を開始いただくことが可能です。）</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-eleven" class="panel-collapse collapse">
								<div class="panel-body">
									...
									<p>運営よりご連絡いたします。キャンセルのタイミングによっては、販売金額の一部をお支払い致します。</p>
					...
					<div class="panel-group" id="eateraccordion">
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="eater-two" class="panel-collapse collapse">
								<div class="panel-body">
									<p>お料理の味の感じ方は人それぞれです。シェアメシでは、様々なメシクリエーターさんからあなたに合ったメシクリエーターさんを選んで頂くことができます。ぜひあなただけのお気に入りのメシクリエーターさんを見つけてみてください。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="eater-three" class="panel-collapse collapse">
								<div class="panel-body">
									<p>お料理は基本的にメシクリエーターさんご本人、あるいはそのご家族によってお届けされます。これはお料理のお届けまでをメシクリエーターさん本人またはご家族に行っていただくことで、その思いも地域のメシイーターさんにお届けいただいたり、見守り役としての役目も果たして頂くなど、シェアメシを通してメシクリエーターさんとのコミュニケーションや繋がりを楽しんで頂きたいと願っておりますためです。お受け取り頂き、お食事を済まされた後、メシクリエーターさんへの評価をお願いしております。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="eater-four" class="panel-collapse collapse">
								<div class="panel-body">
									...
									<p>ただしご自宅以外へのお届けをどうしても希望される場合は、運営にご連絡ください。ご連絡は<a href="/contact-us">こちら</a>から。</p>
									<p>※近日公開予定のバージョンアップ版では、ご自宅以外のお届けも可能となるよう、チャット機能を追加予定です。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#eateraccordion" href="#eater-six">
									<h4 class="panel-title">
										メシクリエーターさんは一般の主婦の方も多いみたいだけど素人が作っても大丈夫なの？調理師の免許などは不要なの？
									<span class="pull-right"><i class="fa fa-plus"></i></span>
									</h4>
								</a>
							</div><!-- panel-heading -->
						...
						<div class="panel panel-default panel-faq">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#eateraccordion" href="#eater-seven">
									<h4 class="panel-title">
										食あたり等、メシクリエーターさんのお料理を食べて問題が発生した場合はどうなるの？
										<span class="pull-right"><i class="fa fa-plus"></i></span>
									</h4>
								</a>
							</div><!-- panel-heading -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="eater-eight" class="panel-collapse collapse">
								<div class="panel-body">
									<p>Paypalを通じてクレジットカードでお支払い頂きます。メシクリエーターさんの地域貢献/見守り、配送、お料理の３点の価格に、運営手数料を加えて価格をお支払い頂き、お料理をご予約頂きます。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="eater-thirteen" class="panel-collapse collapse">
								<div class="panel-body">
									<p>基本的に値引き交渉は応じる事が出来ません。メシクリエーターさんは鮮度の高く、手間暇のかかったお料理を提供されておりますので、値引きする事は難しいです。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="eater-fourteen" class="panel-collapse collapse">
								<div class="panel-body">
									<p>例えば、有機野菜や無農薬野菜は、スーパーなどで見かける一般の野菜と比べ、価格が高いことが多いです。なぜ高いのか。これは、「野菜の栽培にかけられている手間」が違ってくるからというのが理由のひとつです。大量生産される一般の野菜は、科学肥料や化学合成農薬などが使われるため、効率よく栄養を与えることができたり、害虫や雑草を駆除することができます。シェアメシのメシクリエーターさんは、全て手作りで、一品一品手間暇かけて愛情のこもったお料理を提供されています。またお値段には、地域貢献/見守り料、及び配送料が含まれています。</p>
								</div>
							</div>
						</div><!-- panel -->
