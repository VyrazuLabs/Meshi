					...
					<div class="panel-group" id="accordion">
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-one" class="panel-collapse collapse collapse in">
								<div class="panel-body">
									<p>料理を作り、地域に貢献頂く方のことです。</p>
									<p>おすそ分けしたい料理をシェアメシサイト上にアップし、メシイーターさんへおすそ分け頂きます。地域貢献/見守り、配送、料理の３点について値付けを頂きます。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-two" class="panel-collapse collapse">
								<div class="panel-body">
									<p>料理はメシクリエーターさんご本人、あるいはそのご家族にお届けしてもらうことを推奨しております。これは料理のお届けまでをメシクリエーターさんご本人またはご家族に行っていただくことで、その思いも地域のメシイーターさんにお届けいただいたり、見守り役としての役目も果たして頂くなど、シェアメシを通してメシイーターさんとのコミュニケーションや繋がりを楽しんで頂きたいと願っておりますためです。お渡し頂き、メシクリエーターさんがお食事を済まされ、メシクリエーターさんへ評価をされた後、メシイーターさんへの評価をお願いしております。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-five" class="panel-collapse collapse">
								<div class="panel-body">
									<p>シェアメシのサービスは、その地域に住む方々で、料理を提供したい方、料理を食べたい方をシェアメシサイト上でマッチング、個人個人の繋がりを感じてもらった上で、料理のおすそわけを行うサービスとなります、従い不特定多数へのサービスではなく、地域に密着した助け合いのサービスであると解釈しており、保健所の許可や飲食店営業許可などに抵触するものではありません。</p>
								</div>
							</div>
						</div><!-- panel -->
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-eight" class="panel-collapse collapse">
								<div class="panel-body">
									<p>料理をお届けいただいた後、申請ページより申請していただきます。申請に問題が無いことが確認できましたら6営業日以内に振込が行われます。</p>
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="faq-nine" class="panel-collapse collapse">
								<div class="panel-body">
									<p>1.おすそ分けしたい料理写真、おすすめポイントなどを記載いただいた後、提供可能日、時間を選択頂き、シェアメシサイト上にアップ下さい。</p>
									<p>2.予約が入ればメシイーターさんが指定した時間にお届け頂き完了です。</p>
									<p></p>
									<p>※なおご登録後、運営から順次、写真撮影、動画撮影などの手配をひとりひとりに丁寧に行わせて頂きますので、ご連絡をお待ち下さい。</p>
									<p>（写真撮影や、動画撮影を行わせて頂くことで、メシイーターの方々がメシクリエーターの方々をより身近に感じることができ、より選ばれやすくなります！なお運営からのご連絡前にも、上記ステップで料理のご提供を開始いただくことが可能です。）</p>
								</div>
							</div>
						</div><!-- panel -->
					...
					<div class="panel-group" id="eateraccordion">
						...
						<div class="panel panel-default panel-faq">
							...
							<div id="eater-two" class="panel-collapse collapse">
								<div class="panel-body">
									<p>料理の味の感じ方は人それぞれです。シェアメシでは、様々なメシクリエーターさんからあなたに合ったメシクリエーターさんを選んで頂くことができます。ぜひあなただけのお気に入りのメシクリエーターさんを見つけてみてください。</p>
								</div>
							</div>
						</div><!-- panel -->
