    ...
    <link rel="stylesheet" href="{{ url('frontend/css/slidr.css') }}">     
	...
	<!-- icons -->
	<link rel="icon" href="{{ url('frontend/images/ico/favicon.ico') }}">	
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('frontend/css/custom-responsive.css') }}">
